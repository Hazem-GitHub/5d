...
export class ProductionComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      ///// la vache qui rit
      gsap.from('#lavachequirit-particles .lavachequirit-cow', {
        y: 200,
        x: -100,
        scale: 1.5,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#lavachequirit-product',
          scrub: 2,
          start: 'top bottom',
          end: 'bottom bottom'
        }
      });
      gsap.from('#lavachequirit-particles .lavachequirit-mobile-app', {
        y: 200,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
      ...
      ///// nescafe
      gsap.from('#nescafe-particles .nescafe-alarms', {
        y: 200,
        x: 100,
        scale: 1.5,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#nescafe-product',
          scrub: 2,
          start: 'top bottom',
          end: 'bottom bottom'
        }
      });
      gsap.from('#nescafe-particles .nescafe-mobile-app', {
        y: 200,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
      ...
      ///// lego
      gsap.from('#lego-particles .lego-man', {
        x: -100,
        scale: 1.5,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#lego-product',
          scrub: 1,
          start: 'top bottom',
          end: 'bottom bottom'
        }
      ...
      ///// cheetos
      gsap.from('#cheetos-particles .cheetos-mobile-app', {
        y: 200,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#cheetos-product',
          scrub: 1,
          start: 'top bottom',
          end: 'bottom bottom'
        }
      });
      gsap.from('#cheetos-particles .cheetos-dragon', {
        y: -100,
        scale: 0.5,
        alpha: 1,
        ease: 'none',
      ...
      // gsap.from('#cheetos-particles .cheetos-big-snacks', {
      //   x: -200,
      //   scale: 2,
      //   alpha: 1,
      //   ease: 'none',
      ...
      ///// smurfs
      gsap.from('#smurfs-particles .smurf', {
        y: 200,
        x: 100,
        scale: 1.5,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#smurfs-product',
          scrub: 2,
          start: 'top bottom',
          end: 'bottom bottom'
        }
      });
      gsap.from('#smurfs-particles .smurfs-mobile-app', {
        y: 200,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
      ...
      ///// zeego autostrad
      gsap.from('#zeego-particles .zeego-road', {
        x: 200,
        alpha: 1,
        ease: 'none',
        scrollTrigger: {
          trigger: '#zeego-autostrad-product',
          scrub: 1,
          start: 'top bottom',
          end: 'bottom bottom'
        }
